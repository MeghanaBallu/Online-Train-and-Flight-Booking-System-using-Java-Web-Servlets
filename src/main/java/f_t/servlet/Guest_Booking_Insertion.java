...
@WebServlet("/guest_booking_insertion")
public class Guest_Booking_Insertion extends HttpServlet {
	private static final long serialVersionUID = 1L;

   
    public Guest_Booking_Insertion() {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(res>0) {
			...
			RequestDispatcher rd=request.getRequestDispatcher("GuestPayment.jsp");
