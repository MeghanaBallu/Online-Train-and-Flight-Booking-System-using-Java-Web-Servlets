...
<%@ page import="com.cmr.prj.guestlogin.guest" %>
    ...
    <!---->
        <br>
	     ...
	     <div class="row">
            ...
            <div class="col-md-4">
	             <h3 style="margin-right:200px; margin-left:100px; margin-top:40px" >Your Bookings</h3>
		   ...
		   <div class="col-md-4 ">   	
		        	<a href="guestbookedretrieve" class="btn btn-primary btn-md" style="margin-bottom:-93px; margin-left:-240px">View All</a>
		     </div>   	
