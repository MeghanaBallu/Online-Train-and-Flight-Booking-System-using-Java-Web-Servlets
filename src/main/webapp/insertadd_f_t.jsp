...
%>
    ...
    <div class="container box">
        <h3 class="text-success offset-md-5">Add <span class="glyphicon glyphicon-plane"></span>  /  <span class="fa fa-train"></span> </h3>
        <br>
        <div class="col-md-6 offset-md-3">
            <div>
            <form action="insert_flight_train" method="post">
            <label for="f_tr">Choose Flight/Train</label>&nbsp;&nbsp;&nbsp;
             ...
             <input type="text" name="ftno" id="ftno" placeholder="Number" class="form-control" required >
             <br>
             <label for="ftname">Flight/Train Name</label>
             <input type="text" name="ftname" id="ftname" placeholder="Name" class="form-control" required>
             <br>
             <label for="fcity">From City</label>
             <input type="text" name="fcity" id="fcity" placeholder="From City" class="form-control" required >
             <br>
             <label for="tcity">To City</label>
             <input type="text" name="tcity" id="tcity" placeholder="To City" class="form-control" required>
             <br>
             <label for="tdate">Date</label>
             <input type="date" name="tdate" id="tdate"  class="form-control" required>
             <br>
             <label for="time">Time</label>
             <input type="text" name="time" id="time"  placeholder="Enter the Time"class="form-control" required>
             <br>
             <label for="depname">Departure Station Name</label>
             <input type="text" name="depname" id="depname" placeholder="Departure Station Name" class="form-control" required>
             <br>
             <label for="price">Ticket Price</label>
             <input type="text" name="price" id="price" placeholder="Enter the Price" class="form-control" required>
             <br>
             ...
             <br>
             <button  name="insert" class="btn btn-success btn-md " type="submit" value="insert">Insert</button> 
