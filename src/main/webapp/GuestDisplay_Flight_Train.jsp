 ...
 <%@ page import="java.util.List" %>
    ...
    <!---->
     ...
     <div class="row">
		   ...
		   <div class="col-md-4 ">   	
		        	<a href="guestretrieve_f_t" class="btn btn-primary btn-md" style="margin-top:-50px; margin-left:700px">View All</a>
		     </div>   	
            ...
            <tbody>
                ...
                <tr>
                   ...
                   <td>Rs.<%=fl_tr.getPrice() %></td>
                    ...
                    %>
                    <td><a href="guest_user_book.jsp?<%=querystring %>" class="btn btn-primary btn-md">Book</a></td>
                </tr>
               <%
               }
               %>
