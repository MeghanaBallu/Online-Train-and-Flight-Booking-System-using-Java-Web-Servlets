...
function verifyPassword() {  
  var pw = document.getElementById("ngpass").value;  
...
%>
    ...
    <div class="container login">
        <h4 class="text-success offset-md-4">Reset Password</h4>
           <div class="col-md-7 offset-md-2">
               <form action="guest_reset_password" method="post" onsubmit ="return verifyPassword()">
                <label for="email">Email</label>
                <input type="email" name="email" id="email" placeholder="abc@gmail.com" class="form-control" value=<%=request.getParameter("userName") %> readonly="readonly" required>
                <br>
                <label for="ogpass">Old Password</label>
                <input type="password" name="ogpass" id="ogpass" placeholder="Old Password" class="form-control"  required>
                
                <br>
                <label for="ngpass">New Password</label>
                <input type="password" name="ngpass" id="ngpass" placeholder="New Password" class="form-control" required>
                ...
                <a href="guest_main.jsp" class="btn btn-danger btn-md" type="button">Cancel</a>
                <br><br>
               <center>
