...
%>
    ...
    <nav class="navbar navbar-expand-lg heading ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a href="flight.html" class="nav-link menu">Flight/Train</a></li>
                <li class="nav-item"><a href="admin_login.jsp" class="nav-link menu">Admin Login</a></li>
                <li class="nav-item"><a href="guest_login.jsp" class="nav-link menu">Guest</a></li>
            </ul>
        </div>
    </nav>
    <!---->
    ...
    <div class="col-md-6">
                  ...
                  <h5 style="color:green;">Your seat Numbers will be Updated Soon.Please Login to check your Bookings.</h5>
        ...
        <div class="col-md-9">
            ...
            <table class="table table-striped ">
                ...
                <tbody>
                    ...
                    <tr><td colspan="2" ><b>Final Amount:</b>&nbsp;<%=book1.getNo_of_persons()*dt2.getPrice() %></td></tr>
                </tbody>
            </table>
            <button onclick="window.print()" class="btn btn-info">Print this page</button>
             <a href="main.html"  class="btn btn-danger btn-md ">Cancel</a>
